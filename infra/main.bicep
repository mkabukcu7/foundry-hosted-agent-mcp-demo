...
@description('Comma-separated list of managed-identity object IDs allowed to call the MCP API')
...
var allowedPrincipalIdsArray = !empty(allowedPrincipalIds) ? map(split(allowedPrincipalIds, ','), principalId => trim(principalId)) : []
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    allowedPrincipalIds: allowedPrincipalIdsArray
  }
}
